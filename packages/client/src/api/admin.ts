...
export function useUpdateOrgSettings() {
  ...
  return useMutation({
    mutationFn: (data: Partial<Pick<OrgSettings, 'name' | 'allowedEmailDomain' | 'allowedEmails' | 'domainGatingEnabled' | 'emailAllowlistEnabled' | 'modelPreferences' | 'enabledLoginProviders'>>) =>
