...
export function SlackIcon({ className }: IconProps): JSX.Element {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
...
export function ChannelGenericIcon({ className }: IconProps): JSX.Element {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
const iconMap: Record<string, React.ComponentType<IconProps>> = {
  ...
  web: GlobeIcon,
  api: ApiIcon,
  generic: ChannelGenericIcon,
};

/** Get the icon component for a given channel icon ID. */
export function getChannelIcon(iconId: string): React.ComponentType<IconProps> {
  return iconMap[iconId] ?? ChannelGenericIcon;
}
