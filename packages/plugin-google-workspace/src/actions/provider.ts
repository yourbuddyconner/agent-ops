...
export const googleWorkspaceProvider: IntegrationProvider = {
  service: 'google_workspace',
  displayName: 'Google Workspace',
  authType: 'oauth2',
  supportedEntities: ['files', 'folders', 'permissions', 'documents', 'spreadsheets'],
  oauthScopes: WORKSPACE_SCOPES,
